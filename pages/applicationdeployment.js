        ...
        <main className={classes.containerWrap}>
          <section className={clsx(classes.spaceTop, classes.spaceBottom)}>
            ...
            <Typography variant="h4" align="center">
              A typical application deployment process consists of several key phases. An intuitive approach to completing these steps in a synchronized fashion dictates potential deployment success.
            </Typography>
          </section>
        </main>
