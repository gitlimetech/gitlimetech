...
function DigitalMarketingContent(props) {
...
DigitalMarketingContent.propTypes = {
  onToggleDark: PropTypes.func.isRequired,
  onToggleDir: PropTypes.func.isRequired,
  invert: PropTypes.bool,
};
DigitalMarketingContent.defaultProps = {
  invert: false
};
export default withTranslation(['common', 'agency-landing'])(DigitalMarketingContent);
