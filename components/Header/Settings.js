    ...
    <div className={classes.setting}>
      ...
      >
        <List
          ...
          subheader={(
            <ListSubheader component="div">
              {t('common:agency-landing.header_theme')}
            </ListSubheader>
          )}
        >
          <ListItem>
            <Typography component="div">
              <Grid component="label" container alignItems="center" spacing={1}>
                <Grid item>
                  {t('common:agency-landing.header_light')}
                </Grid>
                <Grid item>
                  <Switch
                    checked={isDark}
                ...
                <Grid item>
                  {t('common:agency-landing.header_dark')}
                </Grid>
              </Grid>
            </Typography>
          </ListItem>
        ...
        <List
          ...
          subheader={(
            <ListSubheader component="div">
              {t('common:agency-landing.header_language')}
            </ListSubheader>
          )}
        >
...
export default withTranslation(['agency-landing', 'common'])(Settings);
